...
• /plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
 ...
 ᴄᴏᴍᴍᴀɴᴅꜱ ᴀɴᴅ ᴜꜱᴀɢᴇ : /tr - ᴛᴏ ᴛʀᴀɴꜱʟᴀᴛᴇʀ ᴛᴇxᴛꜱ ᴛᴏ ᴀ ꜱᴩᴇᴄɪꜰɪᴄ ʟᴀɴɢᴜᴀɢᴇ 
 ...
 ᴜꜱᴀɢᴇ: /telegraph - ꜱᴇɴᴅ ᴍᴇ ᴘɪᴄᴛᴜʀᴇ ᴏʀ ᴠɪᴅ ᴜɴᴅᴇʀ (5ᴍʙ) 
...
╰━━━━━━━━━━━━━━━➣ """
 ...
 ᴅᴇʟᴇᴛᴇ ᴀ ʟᴏᴛ ᴏꜰ ᴍᴇssᴀɢᴇs ꜰʀᴏᴍ ɢʀᴏᴜp!  
 ...
 <i><b>𝚃𝚑𝚒𝚜 ᴄᴏᴍᴍᴀɴᴅ ʜᴇʟᴩꜱ yᴏᴜ ᴛᴏ ꜱʜᴏʀᴛ ᴛᴏ ᴜʀʟ </i></b> 
 ...
 ᴀʟʟ ᴛʜᴇ ᴩɪɴ ʀᴇIPʟᴀᴛᴇᴅ ᴄᴏᴍᴍᴀɴᴅꜱ ᴄᴀɴ ʙᴇ ꜰᴏᴜɴᴅ ʜᴇʀᴇ: 
...
/stream - ɢᴇᴛ sᴛʀᴇᴀᴍᴀʙʟᴇ ᴀɴᴅ ᴅᴏᴡɴʟᴏᴀᴅᴀʙʟᴇ ʟɪɴᴋ ᴏғ ᴀɴʏ ғɪʟᴇ</b>"""
    ...
    MOVIE_UPDATE_NOTIFY_TXT = """🎬 <b>{filename}</b> {tag}

{episodes}🎭 <b>ɢᴇɴʀᴇ :</b> <code>{genres}</code>
📺 <b>ᴏᴛᴛ :</b> <code>{ott}</code>
🎥 <b>ǫᴜᴀʟɪᴛʏ :</b> <code>{quality}</code>
🗣️ <b>ʟᴀɴɢᴜᴀɢᴇ :</b> <code>{language}</code>
⭐ <b>ʀᴀᴛɪɴɢ :</b> <code>{rating}</code>

🔗 <b>ʟɪɴᴋ :</b> {search_link}
